...
public class TextHighlighter {
    ...
    public Spannable highlightString(String completeString, String keyword, Matcher matcher) {

        ArrayList<Integer> indices = matcher.getMatchIndices(completeString, keyword);
